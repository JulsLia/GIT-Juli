...
let menu = {
    name: 'Menu:',
    menuname: ['Classis Lasagne', 'Caesar Salad With Shrimp', 'Eggplant Salad', 'Cream Soup Of Champignons', 'Pizza Barbecue', 'Pasta Bolognese', 'Grilled Beef With Potatoes And Eggplant', 'Meringue Roll'],
};
alert('Menu:');
alert(menu.menuname);
